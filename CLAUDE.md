...
4. **Theming.** Use semantic tokens (`bg-bg`, `bg-surface`, `text-fg`, …) for surfaces. Tonal colors (green/yellow/red/blue/purple/orange) stay raw because they encode meaning (status).
