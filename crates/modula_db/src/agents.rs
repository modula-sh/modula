...
const SEED_AGENTS: &[AgentSeed] = &[
    AgentSeed {
        ...
        rules: &[],
        args: &[],
        prompt: include_str!("../../../apps/engine/templates/agents/jira-scan.md"),
    ...
    AgentSeed {
        ...
        rules: &[],
        args: &[],
        prompt: include_str!("../../../apps/engine/templates/agents/linear-scan.md"),
        spawn_per_variant: false,
        skills: &[],
    },
    AgentSeed {
        ...
        rules: &[],
        args: &[],
        prompt: include_str!("../../../apps/engine/templates/agents/github-scan.md"),
        spawn_per_variant: false,
        skills: &[],
    },
    AgentSeed {
        ...
        args: &[],
        prompt: include_str!("../../../apps/engine/templates/agents/project-manager.md"),
        spawn_per_variant: false,
        skills: &[],
    },
    AgentSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/agents/researcher.md"),
        spawn_per_variant: false,
        skills: &["ai-wiki"],
    },
    AgentSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/agents/worker.md"),
    ...
    AgentSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/agents/code-reviewer.md"),
        spawn_per_variant: true,
        skills: &["ai-wiki"],
    },
    AgentSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/agents/reviewer.md"),
        spawn_per_variant: false,
        skills: &["ai-wiki"],
    },
];
