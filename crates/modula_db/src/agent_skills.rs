...
const SEED_SKILLS: &[SkillSeed] = &[
    SkillSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/skills/engine-api.md"),
        hidden: true,
        position: 10,
    },
    SkillSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/skills/tasks.md"),
        hidden: true,
        position: 20,
    },
    SkillSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/skills/specs.md"),
        hidden: true,
        position: 30,
    },
    SkillSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/skills/workflows.md"),
        hidden: true,
        position: 40,
    },
    SkillSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/skills/worktrees.md"),
        hidden: true,
        position: 50,
    },
    SkillSeed {
        ...
        prompt: include_str!("../../../apps/engine/templates/skills/ai-wiki.md"),
        hidden: false,
        position: 60,
    },
];
