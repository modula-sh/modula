...
use crate::services::mcp_config::McpServer as McpServerModel;
use crate::services::providers::{CreateParams, UpdateParams};
...
impl ProviderService for ProviderHandler {
    ...
    async fn update(
        ...
        let body = req.into_inner();
        let description = if body.clear_description {
            Some(None)
        } else {
